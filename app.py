...
# Model config
MODEL_PATH = 'effefficientnetB3_run7A_best.keras'

# SECURE TOKEN HANDLING
HUGGINGFACE_TOKEN = st.secrets.get("Hhf_POfwQxfpPaFUACMWlGfumOFsMBXqxKWlTP", os.environ.get("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"))
